// Package odata provides OData HTTP client for odata-adapter.
package odata
...
const (
	...
	ErrorCategoryHTTP       = "HTTP_ERROR"       // generic HTTP error
...
// ODataErrorDetail contains error details.
type ODataErrorDetail struct {
	Code    string            `json:"code"`
	Message ODataErrorMessage `json:"message"`
}

// ODataErrorMessage contains localized error message.
