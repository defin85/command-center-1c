...
// Kept for odata-adapter compatibility; direct OData now runs in worker.
const (
...
// Legacy adapter publishes results to these streams.
const (
...
const (
	...
	// Multiple adapter instances in this group will load-balance legacy commands.
