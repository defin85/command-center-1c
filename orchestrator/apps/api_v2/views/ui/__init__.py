...
_EXPORTS: dict[str, tuple[str, str]] = {
    "get_legacy_action_catalog": (f"{_BASE}.actions", "get_legacy_action_catalog"),
    "get_operation_exposure_editor_hints": (f"{_BASE}.actions", "get_operation_exposure_editor_hints"),
