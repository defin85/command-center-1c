...
- Взаимодействие с cluster-service и batch-service
...
3. Set mock batch-service: `install_behavior = "fail"` (TODO)
4. Execute workflow
...
- ❌ Real 1C Mode: не применим (нельзя контролировать batch-service)
...
- ⚠️ Compensation flow: требует mock batch-service
