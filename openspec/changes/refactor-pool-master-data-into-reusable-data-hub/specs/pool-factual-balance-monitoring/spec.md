...
`resolved_bindings` ДОЛЖНЫ (SHALL) хранить как минимум:
- `database_id`;
...
- **THEN** он использует pinned nested `factual_scope_contract.v2` и его `resolved_bindings` как source-of-truth
