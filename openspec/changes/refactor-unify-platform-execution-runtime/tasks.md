...
- [ ] 3.1 Перевести compile `pool run` на атомарные workflow nodes из distribution artifact + document plan artifact.
...
## 7. Validation
- [ ] 7.1 Прогнать `openspec validate refactor-unify-platform-execution-runtime --strict --no-interactive`.
