...
## Open Questions
- Подтвердить production-стратегию внешнего идентификатора документа:
  - primary: GUID документа 1С через OData (если стабильно доступен),
  - fallback: комментарий/доп. реквизит.
