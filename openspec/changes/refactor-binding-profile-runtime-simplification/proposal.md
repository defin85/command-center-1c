...
- Запретить state-changing generated profile materialization в shipped list/detail/preview/runtime path; generated one-off profiles остаются только в explicit remediation/backfill tooling.
...
- Affected code:
  ...
  - `orchestrator/apps/intercompany_pools/workflow_binding_backfill.py`
