...
- [ ] HTTP endpoints в ras-adapter deprecated (Phase 3)
...
- [ ] 1.5.10: Integration tests ⏸️ **ОТЛОЖЕНО** до Phase 2
- [ ] 1.5.11: Dockerfile + docker-compose ⏸️ **ОТЛОЖЕНО**
...
- [ ] Success rate >= 99% (требуется production тестирование)
...
- [ ] 1.6.9: Integration tests с mock SSH server ⏸️ **ОТЛОЖЕНО** до Phase 2
- [ ] 1.6.10: Dockerfile + docker-compose ⏸️ **ОТЛОЖЕНО**
- [ ] 1.6.11: Документация по настройке агента на сервере 1С ⏸️ **ОТЛОЖЕНО**
...
- [ ] 2.12: Integration tests с имитацией failures ⏸️ **ОТЛОЖЕНО** до Phase 3
