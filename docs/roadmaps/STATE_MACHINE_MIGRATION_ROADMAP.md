...
**Subtasks:**
- [ ] 1.1: Создать block_handler.go в ras-adapter
- [ ] 1.2: Создать unblock_handler.go в ras-adapter
- [ ] 1.3: Зарегистрировать все handlers в main.go
- [ ] 1.4: Worker: заменить HTTP вызовы на XADD
- [ ] 1.5: Worker: подписаться на events:ras:* для получения результатов
- [ ] 1.6: Добавить timeout при ожидании события
- [ ] 1.7: Unit tests для handlers
- [ ] 1.8: Integration tests Worker ↔ ras-adapter

**Критерии завершения:**
- [ ] Все 5 RAS операций работают через Streams
