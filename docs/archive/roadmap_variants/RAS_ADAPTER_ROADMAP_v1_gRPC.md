# RAS Adapter Roadmap v1.x - gRPC Hybrid Protocol (SUPERSEDED)

⚠️ **SUPERSEDED BY v2.0 (2025-11-19)**

This document describes the gRPC+REST Hybrid Protocol architecture (v1.0-v1.1)
which was considered but **NOT implemented**.

**Why superseded:** Event-Driven architecture (v2.0) chosen instead.
See [WHY_EVENT_DRIVEN_NOT_GRPC.md](WHY_EVENT_DRIVEN_NOT_GRPC.md) for decision rationale.

**Current roadmap:** [RAS_ADAPTER_ROADMAP.md](../../roadmaps/RAS_ADAPTER_ROADMAP.md) (Event-Driven v2.0)
