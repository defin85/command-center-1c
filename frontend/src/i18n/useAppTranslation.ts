...
export const useArtifactsTranslation = () => useNamespaceTranslation('artifacts')
export const useDecisionsTranslation = () => useNamespaceTranslation('decisions')
...
export const useServiceMeshTranslation = () => useNamespaceTranslation('serviceMesh')
